webboderivacion_db = 'DEV_Ricardo'
webboderivacion_db_table = 'TB_BO_DERIVACION_TEST'
webboderivacion_maxColNumber = 268
webboderivacion_xl_colNameRow = 1
webboderivacion_xl_firstDataRow = webboderivacion_xl_colNameRow + 1
webboderivacion_xl_colCheckFlag = 'A'  # verifica si existe data en esa columna, si no encuentra finaliza el loop de registro de evas
webboderivacion_xl_hoja = 'Sheet'  # Nombre de la hoja donde se encuentra la data
...
webboderivacion = [
    ...
    {'colName': 'FechaDerivacion', 'col': 'Q', 'sqlName': 'FechaDerivacion', 'tipo': 'default'},
    {'colName': 'HoraDerivacion', 'col': 'R', 'sqlName': 'HoraDerivacion', 'tipo': 'default'},
    ...
    {'colName': 'TxtDescripcionDerivacion', 'col': 'U', 'sqlName': 'TxtDescripcionDerivacion', 'tipo': 'default'},
    ...
    {'colName': 'CAMPO_2_1', 'col': 'Y', 'sqlName': 'CAMPO_2_1', 'tipo': 'default'},
    {'colName': 'CAMPO_2_2', 'col': 'Z', 'sqlName': 'CAMPO_2_2', 'tipo': 'default'},
    {'colName': 'CAMPO_2_3', 'col': 'AA', 'sqlName': 'CAMPO_2_3', 'tipo': 'default'},
    {'colName': 'CAMPO_3_1', 'col': 'AB', 'sqlName': 'CAMPO_3_1', 'tipo': 'default'},
    {'colName': 'STATUS', 'col': 'AC', 'sqlName': 'STATUS', 'tipo': 'default'},
    {'colName': 'TXT_PEDIDO_ASOCIADO', 'col': 'AD', 'sqlName': 'TXT_PEDIDO_ASOCIADO', 'tipo': 'default'},
    {'colName': 'ID_CARGA', 'col': 'AE', 'sqlName': 'ID_CARGA', 'tipo': 'default'},
    {'colName': 'AGENTE', 'col': 'AF', 'sqlName': 'USUARIO', 'tipo': 'default'},
