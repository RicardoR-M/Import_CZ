webboseguimiento_db = 'DEV_Ricardo'
webboseguimiento_db_table = 'TB_BO_SEGUIMIENTO_TEST'
webboseguimiento_maxColNumber = 268
webboseguimiento_xl_colNameRow = 1
webboseguimiento_xl_firstDataRow = webboseguimiento_xl_colNameRow + 1
webboseguimiento_xl_colCheckFlag = 'A'  # verifica si existe data en esa columna, si no encuentra finaliza el loop de registro de evas
webboseguimiento_xl_hoja = 'Sheet'  # Nombre de la hoja donde se encuentra la data
...
webboseguimiento = [
    ...
    {'colName': 'FechaSeguimiento', 'col': 'Q', 'sqlName': 'FechaSeguimiento', 'tipo': 'default'},
    {'colName': 'HoraSeguimiento', 'col': 'R', 'sqlName': 'HoraSeguimiento', 'tipo': 'default'},
    ...
    {'colName': 'TxtDescripcionSeguimiento', 'col': 'U', 'sqlName': 'TxtDescripcionSeguimiento', 'tipo': 'default'},
    ...
    {'colName': 'CAMPO_1_4', 'col': 'Z', 'sqlName': 'CAMPO_1_4', 'tipo': 'default'},
